...
class User {
  ...
  factory User.empty() {
    return User(uid: "", username: "", password: "", firstName: "", lastName: "", dateOfBirth: "", gender: UserGender.other, weight: 0.0, height: 0.0, avatarUrl: "", email: "");
  }

  factory User.fromMap(Map<String, dynamic> map) {
    return User(uid: map["uid"], username: map["username"], password: map["password"] ?? "", email: map["email"], firstName: map["firstName"], lastName: map["lastName"], dateOfBirth: map["dateOfBirth"], gender: UserGender.values[map["gender"]], weight: map["weight"]*1.0, height: map["height"]*1.0, avatarUrl: map["avatarUrl"]);
  }
